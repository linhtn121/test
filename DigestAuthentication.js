...
DigestAuthentication.prototype.authenticate = function(nonce, method) {
  // Inspect and validate the challenge.

  this.algorithm = "MD5";
  this.realm = "118.69.135.152";
  this.nonce = nonce;
//  this.opaque = challenge.opaque;
 //this.stale = challenge.stale;
  ...
  this.method = method; //"REGISTER";
  this.uri = "sip:8668@118.69.135.152";

  if(method.indexOf('INVITE') != -1){

  	 this.uri = "sip:"+ua.taget +"@118.69.135.152";
